...
def callback_pot_fields_goal(msg):
    pub_message= rospy.Publisher('goalState', String, queue_size=10)
    pub_message.publish ('pointreachednot')
    ...
    while(rospy.Time.now().to_sec()-ahora<1):
        pub_message.publish ('pointreached')
